        ...
        <div class="logopanel">
           ...
           <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
				...
				<li><a href="emp_registration.php"><span class="icon-arrow-right"></span>Empoyee Registration</a></li>
                <li><a href="employees.php"><span class="icon-arrow-right"></span>Empoyees</a></li>
				<li><a href="attendance.php"><span class="icon-arrow-right"></span>Attendance</a></li>
               <li><a href="emp_sal_search.php"><span class="icon-arrow-right"></span>Employees Salary</a></li>
               <!--  <li><a href="payment_details.php"><span class="icon-arrow-right"></span> Trainees Payment Details</a></li>-->
