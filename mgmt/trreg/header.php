        ...
        <div class="logopanel">
           ...
           <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
				...
				<li><a href="trainingreg.php"><span class="icon-arrow-right"></span>Training Registration</a></li>
				<li><a href="trainees.php"><span class="icon-arrow-right"></span>Trainees</a></li>
