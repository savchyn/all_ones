...
function RenderCssCal(bNewCal)
{
	...
	{
	    vCalHeader += "<td align='center'><select name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();' style='width:100px;'>";
		for (i = 0; i < 12; i += 1)
		{
			if (i === Cal.Month)
			{
		...
		vCalHeader += "<td align='center'><select name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();' style='width:100px;'>";
