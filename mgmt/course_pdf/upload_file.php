        ...
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
            	<div class="alert alert-info" style="width:45%;"> 
					...
					Course Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="course_name" id="course_name" required><br><br>
						
					Course Pdf File <input type="file" name="course_file" required><br><br>
						<input type="submit" name="add_pdf" value="Upload File" style="margin-left:30%;"></form>
                </div><!--alert-->
