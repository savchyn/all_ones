        ...
        <div class="logopanel">
           ...
           <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
				...
				<li><a href="upload_file.php"><span class="icon-arrow-right"></span>Upload Pdf</a></li>
				<li><a href="all_pdfs.php"><span class="icon-arrow-right"></span>Download/Print Pdf</a></li>
        </div><!--leftmenu-->
