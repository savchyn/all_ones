...
if(isset($_GET['did']))
{
	...
	echo '<script>window.location="open_enquiry.php";</script>';
}
?>
...
<div style="clear:both;"></div>
 <div class="rightpanel" style="clear:both;">
    ...
    <?php 
		$data=mysql_query("select * from add_enquiry where enq_status='open' order by id desc")or die(mysql_error());
		while($fetch = mysql_fetch_array($data)){
			...
			<td><a href="open_enquiry.php?did=<?= $fetch['id'];?>"><img src="img/DeleteRed.png" width="20" height="20"></a></td>
			</tr>	
			<?php } 
