...
if(isset($_GET['did']))
{
	$del=mysql_query("delete from users where id='".$_GET['did']."'")or die(mysql_error());
	if($del)
	{
...
<div style="clear:both;"></div>
 <div class="rightpanel" style="clear:both;">
        ...
        <div class="pagetitle">
            ...
            <a href="add_users.php" ><button style="float:right;background:#0b4073;color:#fff;">Add Employee</button></a>
        </div><!--pagetitle-->
    ...
    <td><a href="users.php?did=<?= $fetch['id'];?>"><img src="img/DeleteRed.png" alt="" width="20" height="20"></a></td>
    <?php $i++; } ?>
    </tr>
        </table>
