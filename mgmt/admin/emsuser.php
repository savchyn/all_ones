...
if(isset($_GET['did']))
{
	...
	$delet=mysql_query("delete from emsuser where username='".$_GET['did']."'")or die(mysql_error());
...
<div style="clear:both;"></div>
 <div class="rightpanel" style="clear:both;">
        ...
        <div class="pagetitle">
            ...
            <a href="addemsuser.php" ><button style="float:right;background:#0b4073;color:#fff;">Add Users</button></a>
        </div><!--pagetitle-->
    ...
    <?php 
    $qry=mysql_query("select * from emsuser")or die(mysql_error());
    $i=1;
    ...
    <td><a href="emsuser.php?did=<?= $fetch['username'];?>"><img src="img/DeleteRed.png" alt="" width="20" height="20"></a></td>
    <?php $i++; } ?>
    </tr>
        </table>
