...
<div style="clear:both;"></div>
 <div class="rightpanel" style="clear:both;">
    ...
    <div style="color:#000; margin-top:10px;width:100%;max-width:100%;-webkit-box-sizing: border-box; /* Safari, other WebKit */  -moz-box-sizing: border-box;    /* Firefox, other Gecko */   box-sizing: border-box;word-wrap: break-word;">
    <table class="table table-bordered" style="text-align:center;max-width:100%;word-wrap: break-word;">
    <thead>
    ...
    <?php 
		...
		while($fetch = mysql_fetch_array($data)){
			...
			<td><a href="view_enquiry.php?did=<?= $fetch['id'];?>"><img src="img/DeleteRed.png" width="20" height="20"></a></td>
			</tr>	
			<?php } 
