...
if(isset($_GET['did']))
{
	$que=mysql_query("delete from contactus where id='".$_GET['did']."'")or die(mysql_error());
	if($que)
	{
...
<?php include("header.php");?>
 <div class="rightpanel">
    ...
    <table class="table table-bordered" style="text-align:center;">
        ...
        <tbody>
        	<?php
			$data=mysql_query("select * from contactus order by id desc")or die(mysql_error());
			$i=1;
            ...
            <td><a href="messages.php?did=<?= $fetch['id'];?>"><img src="img/DeleteRed.png" width="20" height="20" style="float:left;"></a><a href="showmessages.php?sid=<?= $fetch['id'];?>"><img src="img/display-icon.png" width="20" height="20" style="float:left; margin-left:20px;"></a></td>
            </tr>
            <?php $i++; }?>
