...
if($result){
   ...
   $bo='<table align="center" border="3px solid black;"><br><br>
   <center><img src="images2/111.jpg" height="90" width="90"></center><br><br>
    ...
    <tr><td height="50" width="400">Course Code : '.$co.' </td><td height="50" width="400">Registration Date : '.$registration_date.' </td></tr>
        ...
        <table class="table table-bordered" align="center" border="3px solid black;" >
          ...
          <tr><td height="50" width="10">Date</td><td height="50" width="200">Credit</td><td height="50" width="200">Due Balance</td><td height="50" width="400">Narration</td> </tr>';
           if($inst =='1'){ 
            ...
            $bo.= '<tr><td> '.$registration_date.'</td> <td>'.$registration_fee.'</td> <td></td> <td>'. $reg_narration.'</td> </tr><tr><td> '.$date1.'</td> <td>'.$ins1.'</td> <td><?php '.$du1.'</td> <td>'. $narr1.'</td> </tr>';
         }
          else{
			  $bo.='<tr><td> '.$registration_date.'</td> <td>'.$registration_fee.'</td> <td></td> <td>'. $reg_narration.'</td> </tr>';
        ...
        if($inst =='2'){ 
          if($fs !='' && $ss ==''){
             $bo.='<tr><td> '.$registration_date.'</td> <td>'.$registration_fee.'</td> <td></td> <td>'. $reg_narration.'</td> </tr><tr><td>'.$date1.'</td> <td>'.$ins1.'</td> <td>'.$du1.'</td> <td>'.$narr1.'</td> </tr>';
          }
        elseif($fs !='' && $ss !=''){
            $bo.='<tr><td> '.$registration_date.'</td> <td>'.$registration_fee.'</td> <td></td> <td>'. $reg_narration.'</td> </tr><tr><td>'. $date1.' </td> <td> '.$ins1.' </td> <td> '.$du2.'</td> <td>'.$narr1.'</td> </tr>
            <tr><td> '.$date2 .'</td> <td>'. $ins2.'</td><td>'.$du2.'</td> <td> '.$narr2.'</td> </tr>'; 
        }
            elseif($fs =='' && $ss !=''){
                 $bo.='<tr><td> '.$registration_date.'</td> <td>'.$registration_fee.'</td> <td></td> <td>'. $reg_narration.'</td> </tr><tr><td> '.$date2 .'</td> <td>'. $ins2.'</td><td>'.$du2.'</td> <td> '.$narr2.'</td> </tr>';
            }
            else{
				$bo.='<tr><td> '.$registration_date.'</td> <td>'.$registration_fee.'</td> <td></td> <td>'. $reg_narration.'</td> </tr>';
				//$bo.='No Fees Submitted Yet';
			}
        } 
if($inst =='3'){ 
