...
<div style="height:400;width:400;"><?php $df="select * from video_news where id='".$_REQUEST['id']."' ";
			...
			{ ?>
			  ...
			  <?php  echo $row['news']."<br/><br/>"; ?>
				...
				<video class="video" poster="http://media.html5media.info/poster.jpg" width="600" height="400" controls="" preload="">
                        <source src="admin/upload/<?php echo $row['video']; ?>" media="only screen and (min-device-width: 568px)"><br/><br/>
				
			</div><br/><br/>
			<div style="width:400px; height:200px;"><?php  echo $row['time'];?>
