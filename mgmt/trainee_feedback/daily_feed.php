...
<div class="rightpanel" style="clear:both;">
   ...
   <form action="" method="post">
       <table class="table table-bordered" style="text-align:center;">
           ...
           <?php 
$que=mysql_query("select * from login_detail order by  Right(registration,4) asc");
    ...
    <td><?php echo $dura;?></td>
           <td><a class="btn btn-primary" href="view.php?rgn=<?php echo $reg_num ;?>">View Feedback</a></td>
